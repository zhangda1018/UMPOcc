...
from projects.mmdet3d_plugin.proood.utils.ssc_loss import BCE_ssc_loss
...
class SGNHeadOcc(nn.Module):
    ...
    def forward(self,  mlvl_feats, img_metas, target):
        ...
        # print('_skip_1_1.shape', _skip_1_1.shape)  # [1, 32, 256, 256] [B, Z, H, W]
        ...
        out_scale_1_2__3D, out_guidance = self.seg_head_1_2(out_scale_1_2__2D) # [1, 1, 16, 128, 128] [B, C, Z, H, W] 
        out_scale_1_2__3D = out_scale_1_2__3D.permute(0, 1, 3, 4, 2) # [1, 1, 128, 128, 16]
